...
<template>
  <div class="max-w-[400px]">
    ...
    <UButton
      :label="saving ? 'Đang chia sẻ... (có thể mất 1 phút)' : 'Chia sẻ bức vẽ của tôi'"
      class="mt-4"
      size="lg"
      block
      :disabled="!canPost"
    ...
    <UAlert
      ...
      color="warning"
      variant="subtle"
      title="Đây là bản thử nghiệm công khai. Vui lòng lưu ý rằng các bức vẽ nhạy cảm hoặc chính trị sẽ bị xóa mà không cần báo trước."
    />
  </div>
</template>
